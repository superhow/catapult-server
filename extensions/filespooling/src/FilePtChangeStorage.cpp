	...
	namespace {
		...
		public:
			...
			void notifyAddCosignature(
				...
				// because this storage is used to create local data not subject to consensus
				m_pOutputStream->write(cosignature.SignerPublicKey);
				m_pOutputStream->write(cosignature.Signature);
