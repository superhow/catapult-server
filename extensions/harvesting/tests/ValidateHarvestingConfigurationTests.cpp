...
// 				const std::string& beneficiaryAddress) {
...
// 			harvestingConfig.BeneficiaryAddress = beneficiaryAddress;
...
// 	TEST(TEST_CLASS, ValidationFailsWhenBeneficiaryAddressIsInvalid) {
// 		AssertInvalidHarvestingConfiguration(CreateHarvestingConfiguration(Valid_Key, Valid_Key, false, Invalid_Key));
// 	}

// 	TEST(TEST_CLASS, ValidationSucceedsWhenBeneficiaryAddressIsValid) {
// 		AssertValidHarvestingConfiguration(CreateHarvestingConfiguration(Valid_Key, Valid_Key, false, Valid_Key));
// 	}
